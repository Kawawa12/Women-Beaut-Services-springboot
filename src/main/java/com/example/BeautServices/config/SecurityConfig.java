    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers("/api/auth/password/**","/api/auth/client/**","/api/customer/**","/api/notifications/**","/api/rooms/**").permitAll()
                        .requestMatchers("/api/bookings/create").hasRole(Role.CUSTOMER.name())
                        .requestMatchers("/api/auth/receptionist/**","/api/auth/admin/all-customers","/api/bookings/**","/api/dashboard/**").hasAnyRole(Role.ADMIN.name(), Role.RECEPTIONIST.name())
